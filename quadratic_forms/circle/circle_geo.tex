...
\\
\solution
\input{solutions/sep/2/4/a6.2.tex}
...
\\
\solution
\input{solutions/sep/2/6/QUADRATIC_FORMS_ASSIGNMENT5.tex}
...
\\
\solution
\input{solutions/sep/2/21/Assignment5.tex}
\item Solve $x^2+ x+1 = 0 $.
\item Solve $\sqrt{5}x^2+ x+\sqrt{5} = 0 $.
%
\\
\solution
\input{solutions/sep/2/23/main.tex}
...
\\
\solution
\input{solutions/oct/2/24/main.tex}
...
%
\solution
\input{solutions/sep/2/27/Assignment-5.tex}
